...
#define _nstates20	14	/* f6 */
#define minseq20	298
#define maxseq20	310
#define _endstate20	13

#define _nstates19	14	/* f5 */
#define minseq19	285
#define maxseq19	297
#define _endstate19	13

#define _nstates18	14	/* f4 */
#define minseq18	272
#define maxseq18	284
#define _endstate18	13

#define _nstates17	14	/* f3 */
#define minseq17	259
#define maxseq17	271
#define _endstate17	13

#define _nstates16	14	/* f2 */
#define minseq16	246
#define maxseq16	258
#define _endstate16	13

#define _nstates15	14	/* f1 */
#define minseq15	233
#define maxseq15	245
#define _endstate15	13

#define _nstates14	14	/* l6 */
#define minseq14	220
#define maxseq14	232
#define _endstate14	13

#define _nstates13	14	/* l5 */
#define minseq13	207
#define maxseq13	219
#define _endstate13	13

#define _nstates12	14	/* l4 */
#define minseq12	194
#define maxseq12	206
#define _endstate12	13

#define _nstates11	14	/* l3 */
#define minseq11	181
#define maxseq11	193
#define _endstate11	13

#define _nstates10	14	/* l2 */
#define minseq10	168
#define maxseq10	180
#define _endstate10	13

#define _nstates9	14	/* l1 */
#define minseq9	155
#define maxseq9	167
#define _endstate9	13

#define _nstates8	11	/* s6 */
#define minseq8	145
#define maxseq8	154
#define _endstate8	10

#define _nstates7	11	/* s5 */
#define minseq7	135
#define maxseq7	144
#define _endstate7	10

#define _nstates6	11	/* s4 */
#define minseq6	125
#define maxseq6	134
#define _endstate6	10

#define _nstates5	11	/* s3 */
#define minseq5	115
#define maxseq5	124
#define _endstate5	10

#define _nstates4	11	/* s2 */
#define minseq4	105
#define maxseq4	114
#define _endstate4	10

#define _nstates3	11	/* s1 */
#define minseq3	95
#define maxseq3	104
...
#define _nstates1	11	/* TrafficGenerator */
#define minseq1	77
#define maxseq1	86
#define _endstate1	10

#define _nstates0	78	/* TrafficLight */
#define minseq0	0
#define maxseq0	76
...
#define PTrafficGenerator	((P1 *)_this)
typedef struct P1 { /* TrafficGenerator */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 6; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
...
#define _NP_	21
#define _nstates21	3 /* np_ */
#define _endstate21	2 /* np_ */

#define _start21	0 /* np_ */
#define _start20	5
#define _start19	5
#define _start18	5
#define _start17	5
